 ...
 * @param head: Address of pointer to the head node.
 * @param str: Str field of the node.
 ...
 * @param head: Address of pointer to the first node.
 ...
 * @param headPtr: Address of pointer to the head node.
 *
 * Return: void
 */
